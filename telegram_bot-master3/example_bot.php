...
class TestBot extends TelegramBot{
	...
	function cmd_kartinka(){
		$this->api->sendPhoto( "https://klike.net/uploads/posts/2019-02/1550472288_1.jpg", "Описание картинки" );
	}
	 ...
	 */
	function cmd_gifka(){
		$this->api->sendDocument( "https://klike.net/uploads/posts/2019-02/1550472288_1.jpg", "Описание гифки" );
	}
	...
	function cmd_novosti(){
		$rss = simplexml_load_file('https://www.pravda.com.ua/rus/rss/view_mainnews/');
		$text = "";
	 ...
	 */
	function cmd_music(){
		$url = "https://www.youtube.com/watch?v=_ck9rbrEv5c&ab_channel=%D0%9D%D1%83%D1%80%D0%BC%D0%B8%D0%BD%D1%81%D0%BA%D0%B8%D0%B9";
	...
	function cmd_podcast(){
		$rss = simplexml_load_file('https://www.radiosvoboda.org/rssfeeds');
